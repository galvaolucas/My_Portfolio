export const WorkData = [
    {
        ...
        companyLogo:require('../../assets/Projects/world_telecom.png').default,
    ...
    },
    {
        ...
        dateEnd:'June/2019',
        companyLogo:require('../../assets/Projects/putt.png').default,
    ...
    },
    {
        ...
        designation:'From June/2019 - June/2020: Electrical Projectist <br/> From June 2020 - Present Days: Analyst Engineer and Coordinator',
        dateJoining:'June/2019',
        dateEnd:'-',
        companyLogo:require('../../assets/Projects/lumen.jpg').default,
